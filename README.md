...
Тестов мало не бывает! Именно такой логикой руководствовался Яндекс, когда обучал нас тестированию.

Проект - пример покрытия тестами Django приложения. Демонстрирует работу библиотек pytest и unittest.
